...
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - SeeMore')

# training/test
parser.add_argument('--is_training', type=int, default=1)
parser.add_argument('--training_stage', type=int, default=1)  # '1' means the first training stage and '2' means the second training stage
...
# model
parser.add_argument('--model_name', type=str, default='seemore')
...
parser.add_argument('--lr_beta', type=float, default=0.0001)
...
def train_wrapper(model):
    ...
    for itr in range(cur_iter, args.max_iterations + 1):
        ...
        if itr % args.test_interval == 0:
            mse = trainer.test(model, test_input_handle, args, itr)
            model.save(itr)
            ...
            print('Best mse: ' + str(best_mse) + ' from iter ' + str(best_itr))
